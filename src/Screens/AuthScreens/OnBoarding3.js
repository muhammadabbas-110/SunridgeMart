import {
  ...
  import itemimg from '../../Assest/Images/besan.png';
  import pagination from '../../Assest/Images/pagination3.png';
        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.bottomView}>
            <Animatable.View
              ...
              delay={1000}>
              <TextBold
                text={'Let’s Fulfil Your House Needs With  Sunridge Foods !'}
                fontSize={30}
                color={'#fff'}
                textAlign={'center'}
              />
              ...
              <TouchableOpacity
                onPress={() => props.navigation.navigate('SignupSocial')}
